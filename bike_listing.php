...
<head>
    ...
    <link rel="stylesheet" href="assets/css/bikelist.css">
</head>
                        ...
                        <div class="card-body bg-light text-center">
                            <div class="mb-2">
                                <h4 class="font-weight-semibold mb-2" style="color:black"> <a class="text-default mb-2"
                                        data-abc="true"><?php echo $title ?></a> </h4> <a style="color:black" href="#"
                           ...
                           <?php $existSql1 = "Select * from `tblbooking` where vid='$vid'";
                                ...
                                <a type="button"
                                     href="bike_details.php?id=<?php echo $row['id'];?>" class="btn bg-book"><i
