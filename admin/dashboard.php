...
<body>
    <?php include 'leftbar.php';?>
     <h3 style="text-align:center;color:blue">DASHBOARD</h3>
    <div class="container">
	<div class="row">
		<div class="col-md-4">
        ...
        <div class="col-md-4">
			<div class="dbox dbox--color-2">
				<div class="dbox__body">
                <?php $res7="SELECT * FROM tblbooked";
                 $res8 = mysqli_query($conn,$res7);
                 $count3= mysqli_num_rows($res8);
                 ?>
					<span class="dbox__count"><?php echo $count3 ?></span>
					<span class="dbox__title">Booked</span>
				</div>
				
				<div class="dbox__action">
                <a href="manage_booked.php" class="dbox__action__btn">More Info</a>
				</div>				
			</div>
		</div>
        <div class="col-md-4">
