...
if(isset($_POST['submit'])){
    ...
    $q = "INSERT INTO `tblvehicle`(`title`, `brand`, `overview`, `price/day`, `image1`, `reg_date`)
     VALUES ('$b_title',' $b_brand',' $b_overview',' $b_price',' $folder',current_timestamp())";
    $result1 = mysqli_query($conn, $q);
     if($result1){
        $error.= '<div class="alert alert-success">Bike Added</div>';
...
<body>
    ...
    <h3 style="text-align:center;color:blue">Post Vehicle</h3>
        ...
        <form method="post" class="text-white" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control form-control sm" name="b_title" required>
                </div>
                <div class="form-group col-md-6">
            ...
            <label for="customFile">Bike Image</label>
