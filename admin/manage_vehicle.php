...
<body>
    ...
    <h3 style="text-align:center;color:blue">Manage Vehicle</h3>
    <div class="container mt-5">
        <h6><?php echo $message; ?></h6>
        <div class="row">
            <a href="postvehicle.php" class="badge bg-primary text-white ml-auto p-2 mr-5">Add Bike</a>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <a href="?action=delete&id=<?php echo $id; ?>" class="delete" title="Delete"
                                    data-toggle="tooltip" onclick="return confirm('Are you sure to remove this Bike?')">
