...
if(isset($_POST['submit'])){
    ...
    $status = $_POST["status"];
    $day = $_POST['day'];
    $price_d = $_POST["price/day"];

    $update = "UPDATE `tblbooked` SET `todate`='$todate',`fromdate`='$fromdate',
    `price`='$price',`status`='$status',`days`='$day',`price/day`='$price_d' WHERE sno=$idupd";
...
<body>
    ...
    <?php 
      $val1 = "SELECT * FROM tblbooked WHERE sno='". $_GET['id']."'";
