...
<?php 
          if(isset($_POST['cancel'])){
            ...
            if($numRows>0)
            {
                echo '<script> alert("You have already Camcelled")</script>';
            ...
            <section class="text-gray-600 body-font overflow-hidden">
                <div class="container px-5 py-24 mx-auto">
                    <div class="lg:w-4/5 mx-auto flex flex-wrap">
                        <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" width=50% height="50%"
                            src="<?php echo $img;?>">
                        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            <h2 class="text-gray-900 text-3xl title-font font-medium mb-1">Brand : <?php echo $brand; ?></h2><br>
                            <h3 class="text-gray-900 text-3xl title-font font-medium mb-1">Title : <?php echo $title; ?></h3><br>
