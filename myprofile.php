...
if(isset($_POST['submit'])){
    ...
    $update = "UPDATE `tbluser` SET `address`='$address',`dateofbirth`= '$yob', WHERE email='" . $email . "'";
...
?>
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input type="date" max-length=4  class="form-control" name="yob"  value="<?php echo $result2['dateofbirth'] ?>"
                    required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" style="color:black"  name="pan" value="<?php echo $result2['pancard']?>" class="form-control" readonly>
            </div>
            <div class="form-group">
