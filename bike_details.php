...
if(isset($_POST['book']))
{
    ...
    $numRows = mysqli_num_rows($result);
        if($numRows>0)
        {
        echo '<script> alert("You have already booked one bike")</script>';
        
        // redirect("bike_listing.php");
        // exit();
        }
        else{
            $sql11 = "INSERT INTO `tblbooking`( `vid`, `email`, `day`, `pickupadd`, `postdate`) 
            VALUES ('$ids','$em','$day',' $pickupadd',current_timestamp())";
...
<body>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="<?php echo $img ?>">
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <form method="post">
        <span class="title-font font-medium text-2xl text-gray-900">For Days :- <input type="number" style="background-color:blue;color:white" id="day" value="1" max=31 min=1 name="day" step="1"></span>
        <br><br>
        <span class="title-font font-medium text-2xl text-gray-900">Total :- <input type="number" style="background-color:white;color:black" id="price" value="<?php echo $price ?>" readonly></span>
        <br><br>
