...
<body>
  ...
  <span id="heading" style="color:blue"><b>GET BIKES IN RENT </b></span>
<div id="slider">  
<div class="slides">  
  <img src="img/homebike2.jpg" width="100%" />
 </div>
  
  <div class="slides">  
  <img src="img/homebike.jpg" width="100%" />
</div>
  
  <div class="slides">  
  <img src="img/homebike3.jpg" />
</div> 
  ...
  <div id="dot"></span><span class="dot"></span><span class="dot"></span><span class="dot"></span></div>
    ...
    <section class="services" id="services">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <p>Get accessories while pickup bike</p>
                <a href="#" class="btn"> read more</a>
            </div>
            ...
            <div class="box">
                <i class="fas fa-motorcycle"></i>
                <h3>0Rs Deposit</h3>
                <p>Get any bike for rent with zero deposit fee</p>
                <a href="#" class="btn"> read more</a>
            </div>
            ...
            <div class="box">
                ...
                <h3>24/7 support</h3>
                <p>Contact any time For any query</p>
                <a href="#" class="btn"> read more</a>
            </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title"> <a style="color:black" data-toggle="collapse"
                                ...
                                class="collapsed"> What do I need to rent a Bike? </a> </h4>
                    </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="text-accordion">
                                <p> Each person who intends to Ride must submit a valid driver's license,Aadhar card and
                                    ...
                                    picked a
                                    bike for rent. If you wish to pay in cash, you must also submit an item of
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title"> <a style="color:black" class="collapsed" data-toggle="collapse"
                                ...
                                do I
                                know about booking confirmation? </a> </h4>
                    </div>
                    <div id="collapseFiveLeftTwo" class="panel-collapse collapse" aria-expanded="false" role="tablist"
                        ...
                        <div class="panel-body">
                            <div class="img-accordion"> <img
                                    src="https://img.icons8.com/color/81/000000/person-female.png" alt=""> </div>
                            <div class="text-accordion">
                                <p>After completing the booking process, you will be able to track your reservations´s
                                    status by accessing your account with your registered login and password and go to
                                    my
                                    booking page. Once your reservation is confirmed, we´ll also send you a payment
                                    link.
                                </p>
                            </div>
                        </div> <!-- end of panel-body -->
                    ...
                    <div id="collapseFiveLeftThree" class="panel-collapse collapse" aria-expanded="false"
                        ...
                        <div class="panel-body">
                            <div class="img-accordion"> <img
                                    src="https://img.icons8.com/color/81/000000/person-female.png" alt=""> </div>
                            <div class="text-accordion">
                                <p> The daily fee at some destinations depend on the pick-up and drop-off times
                                    established
                                    in the rental agreement. In such cases, even if your rental period does not complete
                                    24
                                    hours, you will be charged for a 24 hour rental period. It is important to note that
                                    even if your rental period is less than 24 hours, if you don’t return the vehicle at
                                    the
                                    established time, you will be charged for an additional rental period of 24 hours.
                        ...
                        <div class="panel-body">
                            ...
                            <div class="text-accordion">
                                <p> Yes, you can go ahead and cancel the car rental service. You can do it by contacting
                                    in contact section in
                                    the website, or just by making a call to Revv.
                                    The charges of canceling the booking depend upon the time when you inform the
                                    company.
                                    If you are taking the service of Revv, you can refer to their Fee policy to get
                                    in-depth
                                    information about the canceling process.
                                </p>
                            </div>
                        </div> <!-- end of panel-body -->
                    </div>
    ...
    <div class="container">
        <p>Our mission is to help people pick the right rental. Before you book, we will show you everything you need to
            ...
            that
            you can make the right rental choice for you.</p><br><br>
        ...
        <p> We have access to exclusive lowest prices and free add-ons. Our smart booking search engine will ensure that
            we
            pass those savings on to you! We will show you the best and cheapest price for your rental requirements to
            help
            you find your ideal bike.</p><br><br>
        <h3 style="background-color:#F1F777;color:black">Local Expertise! </h3><br>
        <p> We believe everyone should have a memorable and enjoyable experience with their bike rental. For that reason
            we
            have selected suppliers that are friendly and helpful, reputable and have in-depth local knowledge to ensure
            you
            get the best out of your rental.</p>
