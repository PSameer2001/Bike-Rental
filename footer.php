        ...
        <div class="col-md-12 col-lg-4">
            <div class="dk-footer-box-info">
                ...
                <p class="footer-info-text" style="color:white">
                    Bike-Rental is the provider of rental bikes in Mumbai. Get any rental bike on daily or
                    weekly rental plan. Why pay higher when
                    you can rent a bike at really cheap prices.
                </p>
                ...
                <div class="col-md-6">
                    <div class="contact-us">
                        ...
                        <div class="contact-info">
                            ...
                            <p style="color:white">Somaiya Vidyavihar</p>
                        </div>
                        <!-- End Contact Info -->
                    </div>
                    <!-- End Contact Us -->
            ...
            <div class="row">
                <div class="col-md-12 col-lg-6">
                    <div class="footer-widget footer-left-widget">
                        ...
                        <ul>
                            <li>
                                <a href="admin/adminlogin.php" target="_blank" >Admin Panel</a>
                            </li>
                        </ul>
                        <ul>
                            <li>
